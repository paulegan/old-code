...
<HEAD>
 <TITLE> TCTS | Closed Transaction</TITLE>
...
<TR bgcolor="#333366">
<TD colspan = 3><FONT FACE="Arial, Helvetica" SIZE=4 color="#FFFFFF">Transaction Closed</TD></TR>

<TR bgcolor = "#ffffcc"><TD>
	The transaction <B>#trans_id#</B> was successfully closed.
</TD></TR>
</TABLE>
