...
<HEAD>
 <TITLE> TCTS | Rejected Transaction</TITLE>
...
<TR bgcolor="#333366">
<TD colspan = 3><FONT FACE="Arial, Helvetica" SIZE=4 color="#FFFFFF">Transaction Rejected</TD></TR>

<TR bgcolor = "#ffffcc"><TD>
	The transaction <B>#trans_id#</B> was successfully rejected.
</TD></TR>
</TABLE>
