...
<HEAD>
 <TITLE> TCTS | Integrate Batch</TITLE>
...
<TR bgcolor="#333366">
<TD colspan = 3><FONT FACE="Arial, Helvetica" SIZE=4 color="#FFFFFF">Batch Integration</TD></TR>

<TR bgcolor = "#ffffcc"><TD>
<FORM METHOD=POST ACTION="move.phtml">
<FONT FACE="Arial, Helvetica">
Batch ID : <INPUT TYPE=TEXT LENGTH=8 NAME="batchID">

<P><INPUT TYPE=SUBMIT VALUE="View Batch Details"></P>
</FONT>
</FORM>
</TD></TR>
