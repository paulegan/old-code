...
<HEAD>
 <TITLE> TCTS | Modified Transaction</TITLE>
...
<TR bgcolor="#333366">
<TD colspan = 3><FONT FACE="Arial, Helvetica" SIZE=4 color="#FFFFFF">Transaction Modified</TD></TR>

<TR bgcolor = "#ffffcc"><TD>
	The transaction <B>#trans_id#</B> was successfully modified.
</TD></TR>

</TABLE>

<FORM ACTION=close.phtml METHOD=POST>
<INPUT TYPE=HIDDEN NAME=transID value=#trans_id#>
<INPUT TYPE=HIDDEN NAME=stage value=close>
