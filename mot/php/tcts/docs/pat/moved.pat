...
<HEAD>
 <TITLE> TCTS | Integrated Batch</TITLE>
...
<TR bgcolor="#333366">
<TD colspan = 3><FONT FACE="Arial, Helvetica" SIZE=4 color="#FFFFFF">Batch Integrated</TD></TR>

<TR bgcolor = "#ffffcc"><TD>
	The batch <B>#trans_id#</B> was successfully integrated.
</TD></TR>
