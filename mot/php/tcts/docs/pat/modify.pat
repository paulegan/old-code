...
<HEAD>
 <TITLE> TCTS | Modify Transaction</TITLE>
...
<TR bgcolor = "#ffffcc"><TD>
    ...
    <TR><TD><FONT FACE="Arial, Helvetica" SIZE=3>Employee: </TD>
        <TD><FONT FACE="Arial, Helvetica" SIZE=3><INPUT TYPE=TEXT NAME=emp_cid LENGTH=8 MAXLENGTH=8 VALUE="#emp_cid#"></TD>
    </TR>
    ...
    <TR><TD><FONT FACE="Arial, Helvetica" SIZE=3>
        <INPUT TYPE=SUBMIT VALUE="Modify Transaction">
	</TD>
    </TR>
    </TABLE>
</TD></TR>
