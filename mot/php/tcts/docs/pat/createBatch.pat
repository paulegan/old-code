...
<FORM METHOD=POST ENCTYPE="application/x-www-form-urlencoded" NAME="addForm" ACTION="batch.phtml">
...
<TR>
    ...
    <TD><FONT FACE="Arial, Helvetica" SIZE=3>#user#</FONT></TD>
</TR>

<TR>
     <TD><FONT FACE="Arial, Helvetica" SIZE=3><B>Submitted via: </B></FONT></TD>
     <TD><FONT FACE="Arial, Helvetica" SIZE=3><SELECT NAME="sending">
         #select_sending#
         </SELECT>
     </TD>
</TR>
...
<TR>
    ...
    <TD>
      ...
      <TR>
      <TD>
         <FONT FACE="Arial, Helvetica" SIZE=3><SELECT NAME="center">
         #select_center#
         </SELECT>
	 </FONT>
      </TD>
...
<TR ALIGN="right"><TD COLSPAN = 2><FONT FACE="Arial, Helvetica" SIZE=3>
