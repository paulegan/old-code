...
//  Notes:		
 ...
 class UserAccess extends StandardTable
 {
  var $user;
  var $allowedTabList;
  var $clientFuncs;
  ...
  function UserAccess($user)
  {
   ...
   StandardTable('user_access',$TABLE_DEF['user_access']);
  ...
  // is undefined.
  function getRows(whereClause,order)
  {
   if ($this->coreID2name)
  ...
  function augmentRequest(request)
  {
  ...
  function allowsAccessTo(tabName)
  {
