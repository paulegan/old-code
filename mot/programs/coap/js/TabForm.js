...
function TabForm_write(selectedTab)
{
 ...
 for (var a=0; a<this.tabList.length; a++ ){
   ...
   if ( sel == a )
     write("    <TD BGCOLOR=#CCCCCC VALIGN=CENTER NOWRAP>&nbsp;<FONT FACE=\"Arial,Helvetica\" SIZE=-1 COLOR=#000000>"+this.tabList[a].title+"</FONT>&nbsp;</TD>\n");
   else
     write("    <TD BGCOLOR=#CCCCCC VALIGN=CENTER NOWRAP>&nbsp;<A HREF=\""+(request.uri.replace(/^.*\//,"")+"?tab="+this.tabList[a].name)+"\"><FONT FACE=\"Arial,Helvetica\" SIZE=-1 COLOR=#000000>"+this.tabList[a].title+"</FONT></A>&nbsp;</TD>\n");
 ...
 write("     <IMG SRC=\"images/space.gif\" WIDTH=600 HEIGHT=1>\n");
